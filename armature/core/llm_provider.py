"""
LiteLLM Provider - Universal LLM interface for The Armature.
...
from armature.core.env_loader import get_api_key
from armature.generator.constants import DEFAULT_LLM_MODEL
...
class LiteLLMProvider:
    ...
    Environment Variables (Optional):
        LLM_MODEL: Model name (imported from armature.generator.constants.DEFAULT_LLM_MODEL)
