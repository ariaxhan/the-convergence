...
class WeaveLogger:
    """
    Weave-based observability for The Armature civilizations.
...
def init_weave_logger(
    ...
    Environment Variables:
        WANDB_ENTITY or WEAVE_ORGANIZATION: Organization name (default: "armature-ai")
        WANDB_PROJECT or WEAVE_PROJECT: Project name (default: "learning-society")
    """
