"""
Plugin registry using pluggy for The Armature framework.
...
hookspec = pluggy.HookspecMarker("armature")
hookimpl = pluggy.HookimplMarker("armature")


class ArmatureHookSpec:
    """Hook specifications for The Armature plugin system."""

    @hookspec
    def armature_register_llm_provider(self) -> List[tuple[str, Type[LLMProvider]]]:
        """
    ...
    @hookspec
    def armature_register_mab_strategy(self) -> List[tuple[str, Type[MABStrategy]]]:
        """
    ...
    @hookspec
    def armature_register_memory_system(self) -> List[tuple[str, Type[MemorySystem]]]:
        """
    ...
    @hookspec
    def armature_register_plugin(self) -> List[Plugin]:
        """
...
class PluginRegistry:
    """
    Central registry for all plugins in The Armature.
    ...
    def __init__(self) -> None:
        ...
        self.pm = pluggy.PluginManager("armature")
        self.pm.add_hookspecs(ArmatureHookSpec)
