...
Armature supports custom evaluators for scoring API responses based on your specific criteria. This guide shows you how to add and use custom evaluators.
...
Use evaluators that ship with Armature:
...
```python
from armature.evaluators.base import BaseEvaluator, score_wrapper
...
Tried:
  1. Built-in: armature.evaluators.my_evaluator
...
4. ✅ Test it with `armature optimize your_config.yaml`
5. ✅ Iterate based on results

## Need Help?

- Check `examples/` for complete working examples
- Read `armature/evaluators/gemini_evaluator.py` for a full implementation
