"""
Armature SDK - Programmatic interface for optimization runs.

Provides a clean, type-safe API for backend services to run Armature optimizations
...
from armature.optimization.models import OptimizationSchema
...
def _convert_to_optimization_schema(config: ArmatureConfig, test_cases: Optional[List[Dict]] = None) -> OptimizationSchema:
    """
    Convert ArmatureConfig to internal OptimizationSchema.

    This is a temporary bridge until OptimizationRunner accepts ArmatureConfig directly.

    Args:
        config: ArmatureConfig to convert
    ...
    from armature.optimization.models import APIConfig as InternalApiConfig
    from armature.optimization.models import (
        AuthConfig,
        EarlyStoppingConfig,
        EvolutionConfig,
        ExecutionConfig,
    ...
    from armature.optimization.models import EvaluationConfig as InternalEvaluationConfig
    from armature.optimization.models import SearchSpaceConfig as InternalSearchSpaceConfig
    ...
    agent_config = None
    if config.agent:
        from armature.optimization.models import DiscordAuthConfig, ModelConfig
        ...
        from armature.optimization.models import AgentConfig as InternalAgentConfig
...
async def run_optimization(
    ...
    *,
    ...
    """
    Run Armature optimization programmatically.

    Args:
        config: Armature configuration object
