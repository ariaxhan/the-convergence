"""
Claude API client with armature runtime integration.
...
def _load_extract_confidence() -> Callable[[str], Optional[float]]:
    ...
    module_name = "armature.evaluators.confidence"
...
class ClaudeClient:
    ...
    async def chat(
        ...
        *,
        ...
        try:
            from armature import runtime_select
    ...
    async def record_outcome(
        ...
        *,
        ...
        """
        try:
            from armature import runtime_update
