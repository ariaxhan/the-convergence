"""
AI-Powered Setup for The Armature
...
async def run_ai_powered_setup(project_dir: Path, output_dir: Path) -> Dict[str, Any]:
    ...
    # Explain what The Armature does
    console.print("[bold cyan]What is The Armature?[/bold cyan]")
    console.print("")
    console.print("The Armature is an API optimization framework that finds the best")
    ...
    try:
        ...
        console.print("  2. Run optimization: armature optimize optimization.yaml")
        console.print("")
...
This configuration was generated using The Armature's AI-powered setup,
