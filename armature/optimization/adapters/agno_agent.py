"""
Universal Agno Agent Adapter for The Armature.
...
Bridges the armature optimization framework with any Agno agent implementation,
...
class UniversalAgentAdapter:
    ...
    def _load_runner(self):
        ...
        if self.config_file_path:
            ...
            # __file__ is at armature/optimization/adapters/agno_agent.py
