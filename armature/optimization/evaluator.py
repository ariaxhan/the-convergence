...
class Evaluator:
    ...
    def _load_custom_evaluator(self) -> None:
        ...
        1. Built-in evaluators from armature.evaluators.* package
        ...
        try:
            module = importlib.import_module(f"armature.evaluators.{module_name}")
        ...
        raise ValueError(
            ...
            f"Tried:\n"
            f"  1. Built-in: armature.evaluators.{module_name}\n"
            ...
            f"  - Use a built-in evaluator from armature.evaluators"
        )
    ...
    async def _calculate_metric(
        ...
        # Accuracy metrics require expected output
            ...
            if "expected" not in test_case:
                raise ValueError("Test case missing 'expected' field for accuracy metric")
