"""
Runtime arm evolution using Armature Evolution Engine.
...
from armature.optimization.evolution import EvolutionEngine
from armature.optimization.models import SearchSpaceConfig, SearchSpaceParameter
from armature.types.runtime import RuntimeArm, RuntimeArmTemplate
...
async def evolve_arms(
    ...
    *,
    ...
    Uses Armature EvolutionEngine to mutate/crossover best arms, creating
    ...
    """
    from armature.runtime.online import _get_manager
