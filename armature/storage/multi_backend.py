"""
Multi-Backend Storage Manager for The Armature.
...
from armature.storage.base import StorageError, StorageProtocol
...
class MultiBackendStorage:
    ...
    def __init__(
        ...
        sqlite_path: str = "./data/armature_legacy.db",
        file_base_dir: str = "./data/armature_legacy",
        ...
        print("🔐 Multi-Backend Storage initialized:")
        print(f"   Backends: {', '.join(self.backend_names)}")
        print(f"   Cache: {'Enabled' if cache_enabled else 'Disabled'}")
        print("   Strategy: Dual-write for redundancy, fastest-first for reads")
...
def get_legacy_storage(
    ...
    return MultiBackendStorage(
        ...
        sqlite_path=str(data_path / "armature_legacy.db"),
        file_base_dir=str(data_path / "armature_legacy"),
