...
Three self-contained applications demonstrating multiple Armature modules
...
| [self_improving_classifier](self_improving_classifier/) | Runtime MAB, Confidence Extraction | Evolves classification strategy over 40 texts; tracks accuracy armature with ASCII chart |

## Running

```bash
# From the repo root (ensure armature is installed or on PYTHONPATH)
